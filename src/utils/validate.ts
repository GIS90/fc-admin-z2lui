 ...
 * Create Time: 2024-12-19 23-07-36
 */
 ...
 */
export function validExcelFile(str: string) {
 ...
 * desc: 验证是否包含指定的字符
 */
export function isIncludeChar(str: string, char: string) {
    // no string
    if (!str) {
        return false;
    }
 ...
 * desc: 验证是否为excel文件格式，目前只支持.xls, .xlsx
 */
export function validImageFile(str: string) {
