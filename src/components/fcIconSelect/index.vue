...
<template>
    <div class="fc-icon-select">
        ...
        <el-dialog :title="dgField.title" v-model="dialogVisible" :width="dgField.width" :close-on-click-modal="false"
                   destroy-on-close append-to-body style="padding: 25px;">
