<template>
    <el-container>
        ...
        <el-main class="nopadding">
            <fc-table ref="fcTableRef" :indent="20" :requestApi="setProfileApi" :columns="columns">
...
import { setProfileApi, getRoleListApi } from '@/api/modules/system';
...
const getRoleList = async () => {
    const rList = await getRoleListApi()
